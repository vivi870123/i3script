...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "This script will automatically install a fully-featured Linux desktop" 10 60
	}
...
dialog --title "Installation" --infobox "Installing \`basedevel\` and \`git\` for installing other software required for the installation of other programs." 5 70
installpkg curl
